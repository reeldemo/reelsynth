...
| **AI seam** | Toggle DenoiseOpt cycle-local seam repair on the loaded wavetable (A/B vs classical DualCosine). Session-only; tooltip explains wrap/click repair. Same path as Selected toolbar **Seam·Opt**. |
