...
**Artifact we ship:** `paper/v5/main.tex` → DenoiseOpt (wavetable seam residual / hybrid RL+GA)  
...
| # | Audit correction | In our `paper/v5` body? | Action |
|---|------------------|-------------------------|--------|
...
Searched `paper/v5/**/*.tex` for: MnasNet, Pixel, 78ms, MobileNet, WaveGrad, Noise2Noise, DCUnet, Langevin, Elsken, performance estimation, lower-resolution, ImageNet, 75.2.
...
- Mirror: `reelsynth/docs/papers/denoise_opt/v5/`
