...
- **Second-note poly click** — √N voice headroom is smoothed (~12 ms) so starting a second note no longer hard-chops the held voice (sounded like wrap crackle returning).
